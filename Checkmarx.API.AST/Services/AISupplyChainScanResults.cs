...
namespace Checkmarx.API.AST.Services
{
    ...
    public partial class AISupplyChainScanResults
    {
...
#pragma warning disable CS8618
        public AISupplyChainScanResults(System.Uri aSTServer, System.Net.Http.HttpClient httpClient)
        {
#pragma warning restore CS8618
            BaseUrl = $"{aSTServer.AbsoluteUri}api/ai-sc/reader";
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<AISCSR_PaginatedScanResultsResponse> GetScanResultsAsync(
            Guid scanId,
            string search,
            string assetTypeIds,
            string assetNames,
            ...
            AISCSR_OrderDirection? orderDirection,
            System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "scans/{scanId}/results"
                    ...
                    if (orderColumn != null)
                        urlBuilder_.Append(System.Uri.EscapeDataString("orderColumn")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(orderColumn, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<AISCSR_PaginatedScanResultsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        // ──────────────────────────────────────────────────────────
        // GET /scans/{scanId}/results/aggregate
        // ──────────────────────────────────────────────────────────

        /// <param name="groupBy">
        /// Comma-separated list of fields to group by (1–3 fields, no duplicates).
        /// Supported values: assetType, assetName, provider.
        /// Example: "assetType,provider"
        /// </param>
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<AISCSR_ScanResultsGroupsAggregationResponse> GetAggregateScanResultsGroupsAsync(
            Guid scanId,
            string groupBy,
            string search = null,
            string assetTypeIds = null,
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<AISCSR_ScanResultsGroupsAggregationResponse> GetAggregateScanResultsGroupsAsync(
            Guid scanId,
            string groupBy,
            string search,
            string assetTypeIds,
        ...
        {
            if (groupBy == null)
                throw new System.ArgumentNullException("groupBy");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "scans/{scanId}/results/aggregate"
                    urlBuilder_.Append("scans/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(scanId, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<AISCSR_ScanResultsGroupsAggregationResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            return objectResponse_.Object;
                        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum AISCSR_OrderColumn
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum AISCSR_OrderDirection
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AISCSR_PaginatedScanResultsResponse
    {
        [Newtonsoft.Json.JsonProperty("data", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AISCSR_ScanResult> Data { get; set; }
    ...
    public partial class AISCSR_ScanResult
    {
        ...
        [Newtonsoft.Json.JsonProperty("startLine", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? StartLine { get; set; }

        [Newtonsoft.Json.JsonProperty("startColumn", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? StartColumn { get; set; }

        [Newtonsoft.Json.JsonProperty("endLine", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AISCSR_ScanResultsGroupsAggregationResponse
    {
        [Newtonsoft.Json.JsonProperty("scanGroupsCounter", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AISCSR_ScanResultsGroupCounter> ScanGroupsCounter { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class AISCSR_ScanResultsGroupCounter
    {
        [Newtonsoft.Json.JsonProperty("assetTypeId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public Guid? AssetTypeId { get; set; }
