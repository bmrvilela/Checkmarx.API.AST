...
#pragma warning disable 8618
        private string _baseUrl = "/api/versions";
...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public Versions(Uri serverUrl, System.Net.Http.HttpClient httpClient)
        {
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
            BaseUrl = $"{serverUrl.AbsoluteUri}api/versions";
        ...
        public virtual System.Threading.Tasks.Task<VersionsOut> GetVersionsAsync(string authorization, string accept, System.Guid? correlationId)
        {
            return GetVersionsAsync(authorization, accept, correlationId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<VersionsOut> GetVersionsAsync(string authorization = null, string accept = null, System.Guid? correlationId = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<VersionsOut>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class VersionsOut
    {
        /// <summary>
        /// SAST engine version
        /// </summary>
        [Newtonsoft.Json.JsonProperty("SAST", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SAST { get; set; }

        /// <summary>
        /// IaC Security (KICS) engine version
        /// </summary>
        ...
        /// CxOne version
        /// </summary>
        [Newtonsoft.Json.JsonProperty("CxOne", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CxOne { get; set; }
