...
namespace Checkmarx.API.AST.Services.SASTMetadata
{
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<ScanEngineVersionInfo>> EngineVersionAsync(System.Collections.Generic.IEnumerable<System.Guid> scan_ids, string authorization = null, System.Guid? correlationId = null, string accept = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "engine-version"
                    urlBuilder_.Append("engine-version");
                    urlBuilder_.Append('?');
                    foreach (var item_ in scan_ids) { urlBuilder_.Append(System.Uri.EscapeDataString("scan-ids")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append('&'); }
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ScanEngineVersionInfo>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class ScanEngineVersionInfo
    {
        ...
        [Newtonsoft.Json.JsonProperty("engineVersion", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
