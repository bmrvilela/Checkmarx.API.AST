...
namespace Checkmarx.API.AST
{
    ...
    // Generated from ireland-microengines-reader-SSCS_READER.yaml ("SSCS API - Reader").
    // Same underlying micro-engine as SSCSReader (ireland-reader-SSCS.yaml), but every
    // operation is served under a "/read/" prefix and returns richer per-result data
    // (state, status, isInSource, similarityId, commitUrl) that the plain SSCS API omits.
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
            BaseUrl = $"{serverUrl.AbsoluteUri}api/micro-engines/read";
        ...
        public virtual System.Threading.Tasks.Task<SSCSReaderPredicateHistoryCollection> GetPredicatesHistoryAsync(string similarity_id, System.Collections.Generic.IEnumerable<Guid> project_ids)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SSCSReaderPredicateHistoryCollection> GetPredicatesHistoryAsync(string similarity_id, System.Collections.Generic.IEnumerable<Guid> project_ids, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SSCSReaderPredicateHistoryCollection>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SSCSReaderProjects> GetProjectsAsync(int? pageSize = null, int? currentPage = null, string filters = null, string sort = null, string search = null)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SSCSReaderProjects> GetProjectsAsync(int? pageSize, int? currentPage, string filters, string sort, string search, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SSCSReaderProjects>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SSCSReaderProject> GetProjectAsync(string project, string scan)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SSCSReaderProject> GetProjectAsync(string project, string scan, System.Threading.CancellationToken cancellationToken)
        {
            if (project == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SSCSReaderProject>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SSCSReaderEngineResults>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SSCSReaderGroups> GetGroupsByProjectScanAsync(string project, string scan, string engine, string column, string search, string filters)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SSCSReaderGroups> GetGroupsByProjectScanAsync(string project, string scan, string engine, string column, string search, string filters, System.Threading.CancellationToken cancellationToken)
        {
            if (project == null)
                throw new System.ArgumentNullException("project");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SSCSReaderGroups>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderEngineResult
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderEngineResults
    {
        ...
        public System.Collections.Generic.ICollection<SSCSReaderEngineResult> Entries { get; } = new System.Collections.ObjectModel.Collection<SSCSReaderEngineResult>();

        [Newtonsoft.Json.JsonProperty("scanType", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderGroup
    {
        ...
        public SSCSReaderRuleInfo Metadata { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderGroups
    {
        [Newtonsoft.Json.JsonProperty("entries", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<SSCSReaderGroup> Entries { get; } = new System.Collections.ObjectModel.Collection<SSCSReaderGroup>();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderRuleInfo
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderPredicateAPI
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderPredicateHistory
    {
        ...
        public System.Collections.Generic.ICollection<SSCSReaderPredicateAPI> Predicates { get; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderPredicateHistoryCollection
    {
        ...
        public System.Collections.Generic.ICollection<SSCSReaderPredicateHistory> PredicateHistoryPerProject { get; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderEngineFailure
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderProject
    {
        ...
        public System.Collections.Generic.ICollection<SSCSReaderEngineFailure> EnginesFailures { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.4.0.0 (NJsonSchema v11.3.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SSCSReaderProjects
    {
        [Newtonsoft.Json.JsonProperty("entries", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<SSCSReaderProject> Entries { get; set; }
